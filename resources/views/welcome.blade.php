        ...
        <div class=" w-max-xl min-h-screen px-0  bg-cover bg-no-repeat bg-fixed bg-center text-gray-500 overflow-y-hidden" style="background-image: url({{ asset('image/bk.svg') }});" >           
           ...
           <div class=" rounded-2xl grid grid-cols-5 p-4 rounded-2xl gap-8" >
            ...
            <div class="col-span-5 md:col-span-3 text-left grid grid-rows-3 lg:grid-rows-4 pt-4 mx-auto" data-aos="fade-right"> 
                ...
                <div class="row-span-3 py-3 relative">
                    ...
                    @csrf
                      <div class="md:flex md:items-center mb-6">
                        <div class="md:w-1/3">
                        <x-jet-label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-full-name" value="{{ __('Email') }}" />
                    </div>
                    <div class="md:w-2/3">
              ...
              <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
                  ...
                  <x-jet-label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-password" value="{{ __('Password') }}" />
                </div>
                <div class="md:w-2/3">
            ...
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                  <x-jet-button class="shadow-md bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded w-full">
                      {{ __('Sign in') }}
                  </x-jet-button>
            </div>
            </div>
